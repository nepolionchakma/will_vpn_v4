          ...
          <tbody>
              ...
              <tr>
                <td width="500">
                 ...
                 <td>
                     <span class="badge badge-danger badge-icon"><i class="fa fa-clock-o" aria-hidden="true"></i><span><?php echo date('d-m-Y', strtotime($users_row['date'])).' - '.date('h:i A', strtotime($users_row['date']));?> </span></span>
                </td>
