            ...
            switch ($step) {
              default: ?>
                ...
                if (!isset($_SERVER['HTTPS']) || $_SERVER['HTTPS'] != 'on'){
                  $errors = true; 
                  echo "<div class='notification is-danger' style='padding:12px;'><i class='fa fa-times'></i> SSL ( https:// ) is missing! Please Install SSl Certificate in thi Domain </div>";
                }else{
                  echo "<div class='notification is-success' style='padding:12px;'><i class='fa fa-check'></i>  SSL ( https:// ) is available</div>";
                } 
                ...
                // if(is_dir("path_to_directory/.") != 'off'){
                //   $errors = true; 
                // echo "<div class='notification is-danger' style='padding:12px;'><i class='fa fa-times'></i> Curl PHP extension missing!</div>";
                // }else{
                //   echo "<div class='notification is-success' style='padding:12px;'><i class='fa fa-check'></i> Curl PHP extension available</div>";
                    ...
                    if(!empty($db_host)){
                      ...
                      if(mysqli_connect_errno()){ ?>
                        <form action="index.php?step=1" method="POST">
                          ...
                          <div class="field">
                        <label class="label">Put Yur Url</label>
                            <div class="control">
                      ...
                      $config_file_default    = "../includes/test.default";
                      ...
                      $config_file_default    = "../includes/fn.default";
                      $config_file_name       = "../includes/function.php";    
