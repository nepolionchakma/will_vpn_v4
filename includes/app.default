<?php 
	...
	function user_total_status($user_id) 
	{
		...
		$sql="SELECT COUNT(*) as num FROM tbl_video WHERE `user_id`='$user_id'";
		$res=mysqli_query($mysqli,$sql);
		$row=mysqli_fetch_array($res);
		$total_count+=$row['num'];
		mysqli_free_result($res);

		$sql="SELECT COUNT(*) as num FROM tbl_img_status WHERE `user_id`='$user_id'";
		$res=mysqli_query($mysqli,$sql);
		$row=mysqli_fetch_array($res);
		$total_count+=$row['num'];
		mysqli_free_result($res);

		$sql="SELECT COUNT(*) as num FROM tbl_quotes WHERE `user_id`='$user_id'";
		$res=mysqli_query($mysqli,$sql);
		$row=mysqli_fetch_array($res);
		$total_count+=$row['num'];
		mysqli_free_result($res);
    ...
    if($get_method['method_name']=="home")	
	{
			...
			switch ($data['slider_type']) {
				case 'video':
				  	...
				  	if(!empty($lang_ids)){
						...
						foreach ($lang_ids as $key => $value) {
							$column.='FIND_IN_SET('.$value.', tbl_video.`lang_ids`) OR ';
						}

						$column=rtrim($column,'OR ');

						$query="SELECT tbl_video.`video_title`, tbl_video.`video_thumbnail`, tbl_video.`video_layout`, tbl_video.`totel_viewer` FROM tbl_video
								LEFT JOIN tbl_category ON tbl_video.`cat_id`= tbl_category.`cid` 
								WHERE tbl_video.`status`='1' AND tbl_category.`status`='1' AND tbl_video.`id`='$post_id' AND ($column) ORDER BY tbl_video.`id` DESC";	
			 		}
			 		else{
			 			$query="SELECT tbl_video.`video_title`, tbl_video.`video_thumbnail`, tbl_video.`video_layout`, tbl_video.`totel_viewer` FROM tbl_video
								LEFT JOIN tbl_category ON tbl_video.`cat_id`= tbl_category.`cid` 
								WHERE tbl_video.`status`='1' AND tbl_category.`status`='1' AND tbl_video.`id`='$post_id' ORDER BY tbl_video.`id` DESC";
			 		}
				...
				case 'image':
					...
					if(!empty($lang_ids)){
			 			...
			 			$column='';
						foreach ($lang_ids as $key => $value) {
							$column.='FIND_IN_SET('.$value.', tbl_img_status.`lang_ids`) OR ';
						}

						$column=rtrim($column,'OR ');

						$query="SELECT tbl_img_status.`image_title`, tbl_img_status.`image_file`, tbl_img_status.`image_layout`, tbl_img_status.`total_views` FROM tbl_img_status
								LEFT JOIN tbl_category ON tbl_img_status.`cat_id`= tbl_category.`cid` 
								WHERE tbl_img_status.`status`='1' AND tbl_category.`status`='1' AND tbl_img_status.`id`='$post_id' AND tbl_img_status.`status_type`='image' AND ($column) ORDER BY tbl_img_status.`id` DESC";	
			 		}
			 		else{
			 			$query="SELECT tbl_img_status.`image_title`, tbl_img_status.`image_file`, tbl_img_status.`image_layout`, tbl_img_status.`total_views` FROM tbl_img_status
								LEFT JOIN tbl_category ON tbl_img_status.`cat_id`= tbl_category.`cid` 
								WHERE tbl_img_status.`status`='1' AND tbl_category.`status`='1' AND tbl_img_status.`id`='$post_id' AND tbl_img_status.`status_type`='image' ORDER BY tbl_img_status.`id` DESC";
			 		}
				...
				case 'gif':
				  	...
				  	if(!empty($lang_ids)){
						...
						$query="SELECT tbl_img_status.`image_title`, tbl_img_status.`image_file`, tbl_img_status.`image_layout`, tbl_img_status.`total_views` FROM tbl_img_status
								LEFT JOIN tbl_category ON tbl_img_status.`cat_id`= tbl_category.`cid` 
								WHERE tbl_img_status.`status`='1' AND tbl_category.`status`='1' AND tbl_img_status.`id`='$post_id' AND tbl_img_status.`status_type`='gif' AND ($column) ORDER BY tbl_img_status.`id` DESC";	
			 		}
			 		else{
			 			$query="SELECT tbl_img_status.`image_title`, tbl_img_status.`image_file`, tbl_img_status.`image_layout`, tbl_img_status.`total_views` FROM tbl_img_status
								LEFT JOIN tbl_category ON tbl_img_status.`cat_id`= tbl_category.`cid` 
								WHERE tbl_img_status.`status`='1' AND tbl_category.`status`='1' AND tbl_img_status.`id`='$post_id' AND tbl_img_status.`status_type`='gif' ORDER BY tbl_img_status.`id` DESC";
			 		}
				...
				case 'quote':
				  	...
				  	if(!empty($lang_ids)){
			 			...
			 			$column='';
						foreach ($lang_ids as $key => $value) {
							$column.='FIND_IN_SET('.$value.', tbl_quotes.`lang_ids`) OR ';
						}

						$column=rtrim($column,'OR ');

						$query="SELECT tbl_quotes.`quote`, tbl_quotes.`quote_bg`, tbl_quotes.`quote_font`, tbl_quotes.`total_views` FROM tbl_quotes
								LEFT JOIN tbl_category ON tbl_quotes.`cat_id`= tbl_category.`cid` 
								WHERE tbl_quotes.`status`='1' AND tbl_category.`status`='1' AND tbl_quotes.`id`='$post_id' AND ($column) ORDER BY tbl_quotes.`id` DESC";	
			 		}
			 		else{
			 			$query="SELECT tbl_quotes.`quote`, tbl_quotes.`quote_bg`, tbl_quotes.`quote_font`, tbl_quotes.`total_views` FROM tbl_quotes
								LEFT JOIN tbl_category ON tbl_quotes.`cat_id`= tbl_category.`cid` 
								WHERE tbl_quotes.`status`='1' AND tbl_category.`status`='1' AND tbl_quotes.`id`='$post_id' ORDER BY tbl_quotes.`id` DESC";
			 		}
		...
		if(!empty($lang_ids)){
			...
			$query="SELECT * FROM tbl_video
					LEFT JOIN tbl_category ON tbl_video.`cat_id`= tbl_category.`cid` 
					WHERE tbl_video.`status`='1' AND tbl_video.`video_layout`='Portrait' AND tbl_category.`status`='1' AND ($column) ORDER BY tbl_video.`id` DESC LIMIT 5";	
 		}
 		else{
 			$query="SELECT * FROM tbl_video
					LEFT JOIN tbl_category ON tbl_video.`cat_id`= tbl_category.`cid` 
		...
		if(!empty($lang_ids)){
			...
			$query="SELECT * FROM tbl_img_status
					LEFT JOIN tbl_category ON tbl_img_status.`cat_id`= tbl_category.`cid` 
					WHERE tbl_img_status.`status`='1' AND tbl_img_status.`image_layout`='Portrait' AND tbl_category.`status`='1' AND ($column) ORDER BY tbl_img_status.`id` DESC LIMIT 5";	
 		}
 		else{
 			$query="SELECT * FROM tbl_img_status
					LEFT JOIN tbl_category ON tbl_img_status.`cat_id`= tbl_category.`cid` 
					WHERE tbl_img_status.`status`='1' AND tbl_img_status.`image_layout`='Portrait' AND tbl_category.`status`='1' ORDER BY tbl_img_status.`id` DESC LIMIT 5";
 		}
	...
	else if($get_method['method_name']=="landscape_status")
 	{
		...
		if(!empty($lang_ids)){
			...
			$query="SELECT * FROM tbl_video
					LEFT JOIN tbl_category ON tbl_video.`cat_id`= tbl_category.`cid` 
					WHERE tbl_video.`status`='1'AND tbl_video.`video_layout`='Landscape' AND tbl_category.`status`='1' AND ($column) ORDER BY tbl_video.`id` $video_order_by LIMIT $limit, $page_limit";
 		}
 		else{
			$query="SELECT * FROM tbl_video
					LEFT JOIN tbl_category ON tbl_video.`cat_id`= tbl_category.`cid` 
		...
		while($data = mysqli_fetch_assoc($sql))
		{
			...
			$query1 = mysqli_query($mysqli,"select * from tbl_like WHERE post_id='".$data['id']."' && device_id='".$get_method['user_id']."' && like_type='video'"); 
		...
		if(!empty($lang_ids)){
			...
			$query="SELECT * FROM tbl_img_status
					LEFT JOIN tbl_category ON tbl_img_status.`cat_id`= tbl_category.`cid` 
					WHERE tbl_img_status.`status`='1'AND tbl_img_status.`image_layout`='Landscape' AND tbl_category.`status`='1' AND ($column) ORDER BY tbl_img_status.`id` $video_order_by LIMIT $limit, $page_limit";
 		}
 		else{
			$query="SELECT * FROM tbl_img_status
					LEFT JOIN tbl_category ON tbl_img_status.`cat_id`= tbl_category.`cid` 
					WHERE tbl_img_status.`status`='1'AND tbl_img_status.`image_layout`='Landscape' AND tbl_category.`status`='1' ORDER BY tbl_img_status.`id` $video_order_by LIMIT $limit, $page_limit";
 		}
		...
		while($data = mysqli_fetch_assoc($sql))
		{
			...
			$query1 = mysqli_query($mysqli,"select * from tbl_like WHERE post_id='".$data['id']."' && device_id='".$get_method['user_id']."' && like_type='".$data['status_type']."'"); 
		...
		if(!empty($lang_ids)){
			...
			$query="SELECT * FROM tbl_quotes
					LEFT JOIN tbl_category ON tbl_quotes.`cat_id`= tbl_category.`cid` 
					WHERE tbl_quotes.`status`='1' AND tbl_category.`status`='1' AND ($column) ORDER BY tbl_quotes.`id` $video_order_by LIMIT $limit, $page_limit";
 		}
 		else{
			$query="SELECT * FROM tbl_quotes
					LEFT JOIN tbl_category ON tbl_quotes.`cat_id`= tbl_category.`cid` 
					WHERE tbl_quotes.`status`='1' AND tbl_category.`status`='1' ORDER BY tbl_quotes.`id` $video_order_by LIMIT $limit, $page_limit";
 		}
		...
		while($data = mysqli_fetch_assoc($sql))
		{
			...
			$query1 = mysqli_query($mysqli,"select * from tbl_like WHERE post_id='".$data['id']."' && device_id='".$get_method['user_id']."' && like_type='quote'"); 
 	...
 	else if($get_method['method_name']=="portrait_status")
 	{
		...
		if(!empty($lang_ids)){
			...
			$query="SELECT * FROM tbl_video
					LEFT JOIN tbl_category ON tbl_video.`cat_id`= tbl_category.`cid` 
					WHERE tbl_video.`status`='1'AND tbl_video.`video_layout`='Portrait' AND tbl_category.`status`='1' AND ($column) ORDER BY tbl_video.`id` $video_order_by LIMIT $limit, $page_limit";
 		}
 		else{
			$query="SELECT * FROM tbl_video
					LEFT JOIN tbl_category ON tbl_video.`cat_id`= tbl_category.`cid` 
		...
		if(!empty($lang_ids)){
			...
			$query="SELECT * FROM tbl_img_status
					LEFT JOIN tbl_category ON tbl_img_status.`cat_id`= tbl_category.`cid` 
					WHERE tbl_img_status.`status`='1'AND tbl_img_status.`image_layout`='Portrait' AND tbl_category.`status`='1' AND ($column) ORDER BY tbl_img_status.`id` $video_order_by LIMIT $limit, $page_limit";
 		}
 		else{
			$query="SELECT * FROM tbl_img_status
					LEFT JOIN tbl_category ON tbl_img_status.`cat_id`= tbl_category.`cid` 
					WHERE tbl_img_status.`status`='1'AND tbl_img_status.`image_layout`='Portrait' AND tbl_category.`status`='1' ORDER BY tbl_img_status.`id` $video_order_by LIMIT $limit, $page_limit";
 		}
    ...
    else if($get_method['method_name']=="related_status")
 	{
		...
		if(!empty($lang_ids)){
			...
			$query="SELECT * FROM tbl_video
				LEFT JOIN tbl_category ON tbl_video.`cat_id`=tbl_category.`cid` 
				WHERE tbl_video.`id` <> '$post_id' AND tbl_video.`status`='1' AND tbl_category.`status`='1' AND tbl_video.`video_layout`='$layout' AND tbl_video.`cat_id`='$cat_id' AND ($column) ORDER BY tbl_video.`id` ".$post_order_by." LIMIT $limit, $page_limit";
 		}
 		else{
			$query="SELECT * FROM tbl_video
				LEFT JOIN tbl_category ON tbl_video.`cat_id`=tbl_category.`cid` 
				WHERE tbl_video.`id` <> '$post_id' AND tbl_video.`status`='1' AND tbl_category.`status`='1' AND tbl_video.`video_layout`='$layout' AND tbl_video.`cat_id`='$cat_id' ORDER BY tbl_video.`id` ".$post_order_by." LIMIT $limit, $page_limit";
 		}
		...
		{	
			...
			$query1 = mysqli_query($mysqli,"SELECT * FROM tbl_like WHERE `post_id`='".$data['id']."'AND `device_id`='".$get_method['user_id']."' AND `like_type`='video'"); 
		...
		if(!empty($lang_ids)){
			...
			$query="SELECT * FROM tbl_img_status
				LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
				WHERE tbl_img_status.`id` <> '$post_id' AND tbl_img_status.`status`='1' AND tbl_category.`status`='1' AND tbl_img_status.`image_layout`='$layout' AND tbl_img_status.`cat_id`='$cat_id' AND ($column) ORDER BY tbl_img_status.`id` ".$post_order_by." LIMIT $limit, $page_limit";
 		}
 		else{
			$query="SELECT * FROM tbl_img_status
				LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
				WHERE tbl_img_status.`id` <> '$post_id' AND tbl_img_status.`status`='1' AND tbl_category.`status`='1' AND tbl_img_status.`image_layout`='$layout' AND tbl_img_status.`cat_id`='$cat_id' ORDER BY tbl_img_status.`id` ".$post_order_by." LIMIT $limit, $page_limit";
 		}
		...
		if($layout=='Landscape')
		{
			...
			if(!empty($lang_ids)){
				...
				$query="SELECT * FROM tbl_quotes
					LEFT JOIN tbl_category ON tbl_quotes.`cat_id`=tbl_category.`cid` 
					WHERE tbl_quotes.`id` <> '$post_id' AND tbl_quotes.`status`='1' AND tbl_category.`status`='1' AND tbl_quotes.`cat_id`='$cat_id' AND ($column) ORDER BY tbl_quotes.`id` ".$post_order_by." LIMIT $limit, $page_limit";
	 		}
	 		else{

				$query="SELECT * FROM tbl_quotes
					LEFT JOIN tbl_category ON tbl_quotes.`cat_id`=tbl_category.`cid` 
					WHERE tbl_quotes.`id` <> '$post_id' AND tbl_quotes.`status`='1' AND tbl_category.`status`='1' AND tbl_quotes.`cat_id`='$cat_id' ORDER BY tbl_quotes.`id` ".$post_order_by." LIMIT $limit, $page_limit";
	 		}
	...
	else if($get_method['method_name']=="otp_status")
	{
	...
	else if($get_method['method_name']=="get_cat_lang_list")
 	{
		...
		$query="SELECT * FROM tbl_language WHERE tbl_language.`status`='1' ORDER BY tbl_language.`language_name`";
		$sql = mysqli_query($mysqli,$query)or die(mysqli_error($mysqli));
	...
	else if($get_method['method_name']=="home_cat_list")
 	{
		...
		$query="SELECT * FROM tbl_category WHERE tbl_category.`status`='1' AND tbl_category.`show_on_home`='1' ORDER BY tbl_category.$cat_order DESC LIMIT $limit";
		$sql = mysqli_query($mysqli,$query)or die(mysqli_error($mysqli));

		if($sql->num_rows == 0){

			mysqli_free_result($sql);
			$query="SELECT * FROM tbl_category WHERE tbl_category.`status`='1' ORDER BY tbl_category.$cat_order DESC LIMIT $limit";
	...
	elseif ($get_method['method_name']=="get_language") {
		...
		$query="SELECT * FROM tbl_language WHERE tbl_language.`status`='1' ORDER BY tbl_language.`id`";
	...
	{		
 		...
 		if($get_method['filter_value']!="")
 		{
			...
			// for video status
 			...
 			if(!empty($lang_ids)){
				...
				$query="SELECT * FROM tbl_video
					LEFT JOIN tbl_category ON tbl_video.`cat_id`=tbl_category.`cid` 
					WHERE tbl_video.`status`='1' AND tbl_video.`video_layout`='$filter_value' AND tbl_category.`status`='1' AND tbl_video.`cat_id`='$cat_id' AND ($column) ORDER BY tbl_video.`id` ".$post_order_by." LIMIT $limit, $page_limit";	
	 		}
	 		else{
	 			$query="SELECT * FROM tbl_video
					LEFT JOIN tbl_category ON tbl_video.`cat_id`=tbl_category.`cid` 
					WHERE tbl_video.`status`='1' AND tbl_video.`video_layout`='$filter_value' AND tbl_category.`status`='1' AND tbl_video.`cat_id`='$cat_id' ORDER BY tbl_video.`id` ".$post_order_by." LIMIT $limit, $page_limit";
	 		}
			...
			if(!empty($lang_ids)){
				...
				$query="SELECT * FROM tbl_img_status
						LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
						WHERE tbl_img_status.`status`='1' AND tbl_img_status.`image_layout`='$filter_value' AND tbl_category.`status`='1' AND tbl_img_status.`cat_id`='$cat_id' AND ($column) ORDER BY tbl_img_status.`id` ".$post_order_by." LIMIT $limit, $page_limit";	
	 		}
	 		else{
	 			$query="SELECT * FROM tbl_img_status
						LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
						WHERE tbl_img_status.`status`='1' AND tbl_img_status.`image_layout`='$filter_value' AND tbl_category.`status`='1' AND tbl_img_status.`cat_id`='$cat_id' ORDER BY tbl_img_status.`id` ".$post_order_by." LIMIT $limit, $page_limit";
	 		}
			...
			if(!empty($lang_ids)){
				...
				$query="SELECT * FROM tbl_quotes
						LEFT JOIN tbl_category ON tbl_quotes.`cat_id`=tbl_category.`cid` 
						WHERE tbl_quotes.`status`='1' AND tbl_category.`status`='1' AND tbl_quotes.`cat_id`='$cat_id' AND ($column) ORDER BY tbl_quotes.`id` ".$post_order_by." LIMIT $limit, $page_limit";	
	 		}
	 		else{
	 			$query="SELECT * FROM tbl_quotes
						LEFT JOIN tbl_category ON tbl_quotes.`cat_id`=tbl_category.`cid` 
						WHERE tbl_quotes.`status`='1' AND tbl_category.`status`='1' AND tbl_quotes.`cat_id`='$cat_id' ORDER BY tbl_quotes.`id` ".$post_order_by." LIMIT $limit, $page_limit";
	 		}
 		...
 		else
 		{
			// for video status
 			...
 			if(!empty($lang_ids)){
				...
				$query="SELECT * FROM tbl_video
					LEFT JOIN tbl_category ON tbl_video.`cat_id`=tbl_category.`cid` 
					WHERE tbl_video.`status`='1' AND tbl_category.`status`='1' AND tbl_video.`cat_id`='$cat_id' AND ($column) ORDER BY tbl_video.`id` ".$post_order_by." LIMIT $limit, $page_limit";	
	 		}
	 		else{
	 			$query="SELECT * FROM tbl_video
					LEFT JOIN tbl_category ON tbl_video.`cat_id`=tbl_category.`cid` 
					WHERE tbl_video.`status`='1' AND tbl_category.`status`='1' AND tbl_video.`cat_id`='$cat_id' ORDER BY tbl_video.`id` ".$post_order_by." LIMIT $limit, $page_limit";
	 		}
			...
			if(!empty($lang_ids)){
				...
				$query="SELECT * FROM tbl_img_status
						LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
						WHERE tbl_img_status.`status`='1' AND tbl_category.`status`='1' AND tbl_img_status.`cat_id`='$cat_id' AND ($column) ORDER BY tbl_img_status.`id` ".$post_order_by." LIMIT $limit, $page_limit";
	 		}
	 		else{
	 			$query="SELECT * FROM tbl_img_status
						LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
						WHERE tbl_img_status.`status`='1' AND tbl_category.`status`='1' AND tbl_img_status.`cat_id`='$cat_id' ORDER BY tbl_img_status.`id` ".$post_order_by." LIMIT $limit, $page_limit";
	 		}
 	...
 	{	 
		...
		$success=1;
 		...
 		switch ($type) {
 			case 'video':
 					{
	 					$sql="SELECT * FROM tbl_video LEFT JOIN tbl_category
	 							ON tbl_video.`cat_id`=tbl_category.`cid`
	 							WHERE tbl_video.`id`='$status_id' AND tbl_category.`status`='1'";
	 					...
	 					if($res->num_rows > 0){
							...
							$row['total_comment'] = CountRow('tbl_comments',"post_id='".$status_id."' AND type='video'");
				    		...
				    		$res_like = mysqli_query($mysqli,"SELECT * FROM tbl_like WHERE `post_id`='".$status_id."' && `device_id`='".$user_id."' && `like_type`='video'"); 
							...
							$sql_follower = "SELECT * FROM tbl_follows WHERE `user_id`='".$data['user_id']."' AND `follower_id`= '$user_id'"; 
							...
							$sql_comment="SELECT * FROM tbl_comments WHERE `post_id`='".$status_id."' AND `status`='1' AND `type`='video' ORDER BY `id` DESC LIMIT 2";
 			...
 			case 'image':
 					{
	 					$sql="SELECT * FROM tbl_img_status LEFT JOIN tbl_category
	 							ON tbl_img_status.`cat_id`=tbl_category.`cid`
	 							WHERE tbl_img_status.`id`='$status_id' AND tbl_img_status.`status_type`='$type'  AND tbl_category.`status`='1'";
	 					...
	 					if($res->num_rows > 0){
							...
							$row['total_comment'] = CountRow('tbl_comments',"post_id='".$status_id."' AND type='".$type."'");
				    		...
				    		$res_like = mysqli_query($mysqli,"SELECT * FROM tbl_like WHERE `post_id`='".$status_id."' && `device_id`='".$user_id."' && `like_type`='".$type."'"); 
							...
							$sql_comment="SELECT * FROM tbl_comments WHERE `post_id`='".$status_id."' AND `status`='1' AND `type`='".$type."' ORDER BY id DESC LIMIT 2";
 			...
 			case 'quote':
 					{
	 					$sql="SELECT * FROM tbl_quotes LEFT JOIN tbl_category
	 							ON tbl_quotes.`cat_id`=tbl_category.`cid`
	 							WHERE tbl_quotes.`id`='$status_id' AND tbl_category.`status`='1'";
	 					...
	 					if($res->num_rows > 0){
							...
							$row['total_comment'] = CountRow('tbl_comments',"post_id='".$status_id."' AND type='quote'");
				    		...
				    		$res_like = mysqli_query($mysqli,"SELECT * FROM tbl_like WHERE `post_id`='".$status_id."' && `device_id`='".$user_id."' && `like_type`='quote'"); 
							...
							$cat_id=$data['cat_id'];
				   			...
				   			// get comments related to image status
							$sql_comment="SELECT * FROM tbl_comments WHERE `post_id`='".$status_id."' AND `status`='1' AND `type`='quote' ORDER BY id DESC LIMIT 2";
		...
		if(!empty($lang_ids)){
			...
			$query="SELECT * FROM tbl_video
				LEFT JOIN tbl_category ON tbl_video.`cat_id`=tbl_category.`cid` 
				WHERE tbl_video.`id` <> '$status_id' AND tbl_video.`status`='1' AND tbl_category.`status`='1' AND tbl_video.`video_layout`='$layout' AND tbl_video.`cat_id`='$cat_id' AND ($column) ORDER BY tbl_video.`id` DESC LIMIT 5";
 		}
 		else{
			$query="SELECT * FROM tbl_video
				LEFT JOIN tbl_category ON tbl_video.`cat_id`=tbl_category.`cid` 
				WHERE tbl_video.`id` <> '$status_id' AND tbl_video.`status`='1' AND tbl_category.`status`='1' AND tbl_video.`video_layout`='$layout' AND tbl_video.`cat_id`='$cat_id' ORDER BY tbl_video.`id` DESC LIMIT 5";
 		}
		...
		if($sql_video_related->num_rows > 0){
			...
			{	
				...
				$query1 = mysqli_query($mysqli,"SELECT * FROM tbl_like WHERE `post_id`='".$data_related['id']."'AND `device_id`='".$get_method['user_id']."' AND `like_type`='video'"); 
		...
		if(!empty($lang_ids)){
			...
			$query="SELECT * FROM tbl_img_status
				LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
				WHERE tbl_img_status.`id` <> '$status_id' AND tbl_img_status.`status`='1' AND tbl_category.`status`='1' AND tbl_img_status.`image_layout`='$layout' AND tbl_img_status.`cat_id`='$cat_id' AND ($column) ORDER BY tbl_img_status.`id` DESC LIMIT 5";
 		}
 		else{
			$query="SELECT * FROM tbl_img_status
				LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
				WHERE tbl_img_status.`id` <> '$status_id' AND tbl_img_status.`status`='1' AND tbl_category.`status`='1' AND tbl_img_status.`image_layout`='$layout' AND tbl_img_status.`cat_id`='$cat_id' ORDER BY tbl_img_status.`id` DESC LIMIT 5";
 		}
		...
		if($sql_image->num_rows > 0){
			...
			{	
				...
				$query1 = mysqli_query($mysqli,"SELECT * FROM tbl_like WHERE `post_id`='".$data_related['id']."' && `device_id`='".$get_method['user_id']."' && `like_type`='".$data_related['status_type']."'"); 
		...
		if($layout=='Landscape')
		{
			if(!empty($lang_ids)){
				...
				$query="SELECT * FROM tbl_quotes
					LEFT JOIN tbl_category ON tbl_quotes.`cat_id`=tbl_category.`cid` 
					WHERE tbl_quotes.`id` <> '$status_id' AND tbl_quotes.`status`='1' AND tbl_category.`status`='1' AND tbl_quotes.`cat_id`='$cat_id' AND ($column) ORDER BY tbl_quotes.`id` DESC LIMIT 5";
	 		}
	 		else{

				$query="SELECT * FROM tbl_quotes
					LEFT JOIN tbl_category ON tbl_quotes.`cat_id`=tbl_category.`cid` 
					WHERE tbl_quotes.`id` <> '$status_id' AND tbl_quotes.`status`='1' AND tbl_category.`status`='1' AND tbl_quotes.`cat_id`='$cat_id' ORDER BY tbl_quotes.`id` DESC LIMIT 5";
	 		}
			...
			if($sql_quote->num_rows > 0){
				...
				{	
					...
					$query1 = mysqli_query($mysqli,"SELECT * FROM tbl_like WHERE `post_id`='".$data_related['id']."' && `device_id`='".$get_method['user_id']."' && `like_type`='quote'"); 
	...
	else if($get_method['method_name']=="single_status_view_count")
 	{
 		...
 		if($owner_id!=$user_id){
 			switch ($type) {
	 			case 'video':
	 				{
	 					$sql_view="UPDATE tbl_video SET totel_viewer= totel_viewer + 1  WHERE id = '$post_id'";
	 					mysqli_query($mysqli, $sql_view);

	 					if($settings_details['video_views_status']=='true')
	 					{
	 						$sql="SELECT * FROM tbl_users_rewards_activity WHERE `post_id`='$post_id' AND `user_id`='$user_id' AND `activity_type` = '".$app_lang['video_view_activity']."'";
	 						...
	 						if($res->num_rows == 0){
	 							...
	 							$user_update="UPDATE tbl_users SET `total_point`= `total_point` + '".$settings_details['video_views']."' WHERE `id` = '$user_id'";
	 							...
	 							if(user_reward_activity($post_id,$user_id,$app_lang['video_view_activity'],$settings_details['video_views']))
	 							{
					 				...
					 				{
					 					$user_view_qry=mysqli_query($mysqli,"UPDATE tbl_users SET total_point= total_point + '".$settings_details['video_views']."'  WHERE id = '".$owner_id."'");
	 			...
	 			case 'image':
	 				{
		 				$sql_view="UPDATE tbl_img_status SET total_views= total_views + 1  WHERE id = '$post_id'";
		 				mysqli_query($mysqli, $sql_view);

		 				$sql="SELECT * FROM tbl_users_rewards_activity WHERE `post_id`='$post_id' AND `user_id`='$user_id' AND `activity_type` = '".$app_lang['image_view_activity']."'";
		 				...
		 				if($res->num_rows == 0){
		 					...
		 					$user_update="UPDATE tbl_users SET `total_point`= `total_point` + '".$settings_details['image_views']."' WHERE `id` = '$user_id'";
		 					...
		 					if(user_reward_activity($post_id,$user_id,$app_lang['image_view_activity'],$settings_details['image_views'])){
		 						...
		 						{
		 							$user_view_qry=mysqli_query($mysqli,"UPDATE tbl_users SET total_point= total_point + '".$settings_details['image_views']."'  WHERE id = '".$owner_id."'");
	 			...
	 			case 'gif':
	 				{
		 				...
		 				$sql="SELECT * FROM tbl_users_rewards_activity WHERE `post_id`='$post_id' AND `user_id`='$user_id' AND `activity_type` = '".$app_lang['gif_view_activity']."'";
		 				...
		 				if($res->num_rows == 0){
		 					...
		 					$user_update="UPDATE tbl_users SET `total_point`= `total_point` + '".$settings_details['gif_views']."' WHERE `id` = '$user_id'";
		 					...
		 					if(user_reward_activity($post_id,$user_id,$app_lang['gif_view_activity'],$settings_details['gif_views']))
		 					{
		 						...
		 						{
		 							$user_view_qry=mysqli_query($mysqli,"UPDATE tbl_users SET total_point= total_point + '".$settings_details['gif_views']."'  WHERE id = '".$owner_id."'");
	 			...
	 			case 'quote':
	 				{
		 				$sql_view="UPDATE tbl_quotes SET total_views= total_views + 1  WHERE id = '$post_id'";
		 				mysqli_query($mysqli, $sql_view);

		 				$sql="SELECT * FROM tbl_users_rewards_activity WHERE `post_id`='$post_id' AND `user_id`='$user_id' AND `activity_type` = '".$app_lang['quotes_view_activity']."'";
		 				...
		 				if($res->num_rows == 0){
		 					...
		 					$user_update="UPDATE tbl_users SET `total_point`= total_point + '".$settings_details['quotes_views']."' WHERE `id` = '$user_id'";
		 					...
		 					if(user_reward_activity($post_id,$user_id,$app_lang['quotes_view_activity'],$settings_details['quotes_views']))
		 					{
		 						...
		 						{
		 							$user_view_qry=mysqli_query($mysqli,"UPDATE tbl_users SET total_point= total_point + '".$settings_details['quotes_views']."'  WHERE id = '".$owner_id."'");
 	...
 	else if($get_method['method_name']=="user_status_like")
 	{
 		...
 		$sql_like="SELECT * FROM tbl_like WHERE `post_id`='$post_id' AND `device_id`='$user_id' AND `like_type`='$type'";
    	...
    	if(mysqli_num_rows($res_like) == 0)
		{
			...
			$insertSql="INSERT INTO `tbl_like`(`post_id`, `device_id`, `likes`, `like_type`) VALUES ('$post_id','$user_id','1','$type')";

			$insertRes=mysqli_query($mysqli, $insertSql) or die(mysqli_error($mysqli));	

			$query = mysqli_query($mysqli,"SELECT SUM(`likes`) AS `total_likes` FROM tbl_like WHERE post_id='$post_id' AND `like_type`='$type'") or die(mysqli_error($mysqli));
			...
			case 'video':
				{
					if(mysqli_num_rows($res_like) == 0)
					{
						...
						if($settings_details['like_video_points_status']=='true')
						{
							...
							$qry = "SELECT * FROM tbl_users_rewards_activity WHERE `post_id` = '$post_id' AND `user_id`='$user_id' AND `activity_type`='".$app_lang['video_like_activity']."'";

							$result = mysqli_query($mysqli,$qry);

							if ($result->num_rows == 0)
							{
								$user_view_qry=mysqli_query($mysqli,"UPDATE tbl_users SET total_point= total_point + '".$like_point."'  WHERE `id` = '".$user_id."'");
							}            
						...
						$res_delete=mysqli_query($mysqli,"DELETE FROM `tbl_like` WHERE `device_id`='$user_id' AND `post_id`='$post_id' AND `like_type`='$type'");
						...
						if($res_delete){
							...
							if($settings_details['like_video_points_status']=='true')
							{
								...
								$update_point=mysqli_query($mysqli,"UPDATE tbl_users SET total_point= (total_point - '".$like_point."')  WHERE `id` = '$user_id'");

								$res_delete_reward=mysqli_query($mysqli,"DELETE FROM `tbl_users_rewards_activity` WHERE `user_id`='$user_id' AND `post_id`='$post_id' AND `activity_type`='".$app_lang['video_like_activity']."'");
							}
			...
			case 'image':
				{
					if(mysqli_num_rows($res_like) == 0)
					{
						...
						$edit=Update('tbl_img_status', $data, "WHERE `id` = '$post_id'");
						...
						if($settings_details['like_image_points_status']=='true')
						{
							...
							$qry = "SELECT * FROM tbl_users_rewards_activity WHERE `post_id` = '$post_id' AND `user_id`='$user_id' AND `activity_type`='".$app_lang['image_like_activity']."'";
						...
						$query = mysqli_query($mysqli,"SELECT `total_likes` FROM tbl_img_status WHERE `id`='$post_id'"); 
						$row = mysqli_fetch_assoc($query);         
						$total_likes = $row['total_likes']-1;
						...
						$quates_edit=Update('tbl_img_status', $data, "WHERE `id` = '$post_id'");   
						...
						if($res_delete){
							...
							if($settings_details['like_image_points_status']=='true')
							{
								...
								$res_delete_reward=mysqli_query($mysqli,"DELETE FROM `tbl_users_rewards_activity` WHERE `user_id`='$user_id' AND `post_id`='$post_id' AND `activity_type`='".$app_lang['image_like_activity']."'");
							}
			...
			case 'gif':
				{
					if(mysqli_num_rows($res_like) == 0)
					{
						...
						if($settings_details['like_gif_points_status']=='true')
						{
							...
							$qry = "SELECT * FROM tbl_users_rewards_activity WHERE `post_id` = '$post_id' AND `user_id`='$user_id' AND `activity_type`='".$app_lang['gif_like_activity']."'";
						...
						if($res_delete){
							...
							if($settings_details['like_gif_points_status']=='true')
							{
								...
								$res_delete_reward=mysqli_query($mysqli,"DELETE FROM `tbl_users_rewards_activity` WHERE `user_id`='$user_id' AND `post_id`='$post_id' AND `activity_type`='".$app_lang['gif_like_activity']."'");
							}
			...
			case 'quote':
				{
					if(mysqli_num_rows($res_like) == 0)
					{
						...
						$edit=Update('tbl_quotes', $data, "WHERE `id` = '$post_id'");
						...
						if($settings_details['like_quotes_points_status']=='true')
						{
							...
							$qry = "SELECT * FROM tbl_users_rewards_activity WHERE `post_id` = '$post_id' AND `user_id`='$user_id' AND `activity_type`='".$app_lang['quotes_like_activity']."'";
						...
						$query = mysqli_query($mysqli,"SELECT `total_likes` FROM tbl_quotes WHERE `id`='$post_id'"); 
						$row = mysqli_fetch_assoc($query);         
						$total_likes = $row['total_likes']-1;
						...
						$quates_edit=Update('tbl_quotes', $data, "WHERE `id` = '$post_id'");   
						...
						if($res_delete){
							...
							if($settings_details['like_quotes_points_status']=='true')
							{
								...
								$res_delete_reward=mysqli_query($mysqli,"DELETE FROM `tbl_users_rewards_activity` WHERE `user_id`='$user_id' AND `post_id`='$post_id' AND `activity_type`='".$app_lang['quotes_like_activity']."'");
							}
			...
			case 'video':
				{
					...
					{
						$sql="SELECT * FROM tbl_users_rewards_activity WHERE `post_id`='$post_id' AND `user_id`='$user_id' AND `activity_type` = '".$app_lang['video_download_activity']."'";
						...
						if($res->num_rows == 0){
							...
							$user_update="UPDATE tbl_users SET `total_point`= `total_point` + '".$settings_details['download_video_points']."' WHERE `id` = '$user_id'";

							mysqli_query($mysqli, $user_update);

							user_reward_activity($post_id,$user_id,$app_lang['video_download_activity'],$settings_details['download_video_points']);

							$sql_view="UPDATE tbl_video SET total_download= total_download + 1  WHERE id = '$post_id'";
							mysqli_query($mysqli, $sql_view);
			...
			case 'image':
				{
					...
					{
						$sql="SELECT * FROM tbl_users_rewards_activity WHERE `post_id`='$post_id' AND `user_id`='$user_id' AND `activity_type` = '".$app_lang['image_download_activity']."'";
						...
						if($res->num_rows == 0){
							...
							$user_update="UPDATE tbl_users SET `total_point`= `total_point` + '".$settings_details['download_image_points']."' WHERE `id` = '$user_id'";

							mysqli_query($mysqli, $user_update);

							user_reward_activity($post_id,$user_id,$app_lang['image_download_activity'],$settings_details['download_image_points']);

							$sql_view="UPDATE tbl_img_status SET total_download= total_download + 1  WHERE id = '$post_id'";
			...
			case 'gif':
				{
					...
					{
						$sql="SELECT * FROM tbl_users_rewards_activity WHERE `post_id`='$post_id' AND `user_id`='$user_id' AND `activity_type` = '".$app_lang['gif_download_activity']."'";
						...
						if($res->num_rows == 0){
							...
							$user_update="UPDATE tbl_users SET `total_point`= `total_point` + '".$settings_details['download_gif_points']."' WHERE `id` = '$user_id'";
		...
		$limit=($get_method['page']-1) * $page_limit;
 		...
 		if($get_method['filter_value']!="")
 		{
			...
			if(!empty($lang_ids)){
				...
				$query="SELECT * FROM tbl_video
					LEFT JOIN tbl_category ON tbl_video.`cat_id`=tbl_category.`cid` 
					WHERE tbl_video.`status`='1' AND tbl_video.`video_layout`='$filter_value' AND ($column) AND (tbl_video.`video_title` LIKE '%$search_text%' OR tbl_video.`video_tags` LIKE '%$search_text%' OR tbl_category.`category_name` LIKE '%$search_text%') ORDER BY tbl_video.`id` ".$post_order_by." LIMIT $limit, $page_limit";
	 		}
	 		else{
	 			$query="SELECT * FROM tbl_video
					LEFT JOIN tbl_category ON tbl_video.`cat_id`=tbl_category.`cid` 
					WHERE tbl_video.`status`='1' AND tbl_video.`video_layout`='$filter_value' AND (tbl_video.`video_title` LIKE '%$search_text%' OR tbl_video.`video_tags` LIKE '%$search_text%' OR tbl_category.`category_name` LIKE '%$search_text%') ORDER BY tbl_video.`id` ".$post_order_by." LIMIT $limit, $page_limit";
	 		}
			...
			if(!empty($lang_ids)){
				...
				$query="SELECT * FROM tbl_img_status
						LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
						WHERE tbl_img_status.`status`='1' AND tbl_img_status.`image_layout`='$filter_value' AND ($column) AND (tbl_img_status.`image_title` LIKE '%$search_text%' OR tbl_img_status.`image_tags` LIKE '%$search_text%' OR tbl_category.`category_name` LIKE '%$search_text%') ORDER BY tbl_img_status.`id` ".$post_order_by." LIMIT $limit, $page_limit";
	 		}
	 		else{
	 			$query="SELECT * FROM tbl_img_status
						LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
						WHERE tbl_img_status.`status`='1' AND tbl_img_status.`image_layout`='$filter_value' AND (tbl_img_status.`image_title` LIKE '%$search_text%' OR tbl_img_status.`image_tags` LIKE '%$search_text%' OR tbl_category.`category_name` LIKE '%$search_text%') ORDER BY tbl_img_status.`id` ".$post_order_by." LIMIT $limit, $page_limit";
	 		}
			...
			if(!empty($lang_ids)){
				...
				$query="SELECT * FROM tbl_quotes
						LEFT JOIN tbl_category ON tbl_quotes.`cat_id`=tbl_category.`cid` 
						WHERE ($column) AND tbl_quotes.`status`='1' AND (tbl_quotes.`quote` LIKE '%$search_text%' OR tbl_quotes.`quote_tags` LIKE '%$search_text%' OR tbl_category.`category_name` LIKE '%$search_text%') ORDER BY tbl_quotes.`id` ".$post_order_by." LIMIT $limit, $page_limit";
	 		}
	 		else{
	 			$query="SELECT * FROM tbl_quotes
						LEFT JOIN tbl_category ON tbl_quotes.`cat_id`=tbl_category.`cid` 
						WHERE tbl_quotes.`status`='1' AND (tbl_quotes.`quote` LIKE '%$search_text%' OR tbl_quotes.`quote_tags` LIKE '%$search_text%' OR tbl_category.`category_name` LIKE '%$search_text%') ORDER BY tbl_quotes.`id` ".$post_order_by." LIMIT $limit, $page_limit";
	 		}
 		...
 		else
 		{
			...
			if(!empty($lang_ids)){
				...
				$query="SELECT * FROM tbl_video
					LEFT JOIN tbl_category ON tbl_video.`cat_id`=tbl_category.`cid` 
					WHERE ($column) AND tbl_video.`status`='1' AND (tbl_video.`video_title` LIKE '%$search_text%' OR tbl_video.`video_tags` LIKE '%$search_text%' OR tbl_category.`category_name` LIKE '%$search_text%') ORDER BY tbl_video.`id` ".$post_order_by." LIMIT $limit, $page_limit";
	 		}
	 		else{
	 			$query="SELECT * FROM tbl_video
					LEFT JOIN tbl_category ON tbl_video.`cat_id`=tbl_category.`cid` 
					WHERE tbl_video.`status`='1' AND (tbl_video.`video_title` LIKE '%$search_text%' OR tbl_video.`video_tags` LIKE '%$search_text%' OR tbl_category.`category_name` LIKE '%$search_text%') ORDER BY tbl_video.`id` ".$post_order_by." LIMIT $limit, $page_limit";
	 		}
			...
			$query="SELECT * FROM tbl_img_status
				LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
				WHERE tbl_img_status.`status`='1' AND (tbl_img_status.`image_title` LIKE '%$search_text%' OR tbl_img_status.`image_tags` LIKE '%$search_text%' OR tbl_category.`category_name` LIKE '%$search_text%') ORDER BY tbl_img_status.`id` ".$post_order_by." LIMIT $limit, $page_limit";
        ...
        if($uploadStatus){
	        ...
	        if($status==1){
	        	...
	        	if($status_type=='image'){
					...
					{
						$qry="SELECT * FROM tbl_img_status WHERE `id`='$last_id'";
						$result=mysqli_query($mysqli,$qry);
		    		...
		    		if($settings_details['gif_add_status']=='true')
					{
						...
						$sql_activity = "SELECT * FROM tbl_users_rewards_activity WHERE `post_id` = '$last_id' AND `user_id` = '$user_id' AND `activity_type`='".$app_lang['add_gif']."'";
						$res_activity = mysqli_query($mysqli,$sql_activity);
	...
	else if($get_method['method_name']=="upload_quote_status")	
	{
        ...
        if($status==1){
			...
			{
				$qry="SELECT * FROM tbl_quotes WHERE `id`='$last_id'";
				$result=mysqli_query($mysqli,$qry);
				$row=mysqli_fetch_assoc($result); 
			...
			case 'video':
				{
					...
					$sql="SELECT * FROM tbl_users_rewards_activity WHERE `user_id`='$user_id' AND date(`date`) = '$date' AND `activity_type` LIKE '%".$app_lang['add_video']."%'";
				}
				break;
			...
			case 'image':
				{
					...
					$sql="SELECT * FROM tbl_users_rewards_activity WHERE `user_id`='$user_id' AND date(`date`) = '$date' AND `activity_type` LIKE '%".$app_lang['add_image']."%'";
				}
				break;
			...
			case 'gif':
				{
					...
					$sql="SELECT * FROM tbl_users_rewards_activity WHERE `user_id`='$user_id' AND date(`date`) = '$date' AND `activity_type` LIKE '%".$app_lang['add_gif']."%'";
				}
				break;
			...
			case 'quote':
				{
					...
					$sql="SELECT * FROM tbl_users_rewards_activity WHERE `user_id`='$user_id' AND date(`date`) = '$date' AND `activity_type` LIKE '%".$app_lang['add_quote']."%'";
				}
				break;
	...
	else if($get_method['method_name']=="user_register")	
	{
		...
		if($user_type=='Google' || $user_type=='google')
		{
    		...
    		if($num_rows == 0)
    		{
				...
				$is_duplicate='';
				$sql_device="SELECT * FROM tbl_users WHERE `device_id` = '".$device_id."' AND `id` <> '".$row['id']."'";
				$res_device=mysqli_query($mysqli,$sql_device);
				if(mysqli_num_rows($res_device) > 0){
					$is_duplicate='1';
				}else{
	...
	else if($get_method['method_name']=="user_search")	
	{
		...
		$sql="SELECT * FROM tbl_users 
		      WHERE tbl_users.`status`='1' AND tbl_users.`id` <> $user_id AND (tbl_users.`name` LIKE '%$search_keyword%' OR tbl_users.`email` LIKE '%$search_keyword%') ORDER BY tbl_users.`name` DESC LIMIT $limit, $page_limit";
	...
	else if($get_method['method_name']=="user_followers")	
	{
		...
		$sql="SELECT tbl_follows.* FROM tbl_follows, tbl_users 
		      WHERE tbl_follows.`follower_id`=tbl_users.`id` AND tbl_follows.`user_id`='$user_id' ORDER BY tbl_follows.`id` DESC LIMIT $limit, $page_limit";
	...
	else if($get_method['method_name']=="user_following")	
	{
		...
		$sql="SELECT tbl_follows.* FROM tbl_follows, tbl_users 
		      WHERE tbl_follows.`user_id`=tbl_users.`id` AND tbl_follows.`follower_id`='$user_id' ORDER BY tbl_follows.`id` DESC LIMIT $limit, $page_limit";
	...
	else if($get_method['method_name']=="user_profile")	
	{
		...
		$row = mysqli_fetch_assoc($result);
 		...
 		if(mysqli_num_rows($result) > 0){
			...
			$sql="SELECT tbl_follows.* FROM tbl_follows, tbl_users 
		      WHERE tbl_follows.`follower_id`=tbl_users.`id` AND tbl_follows.`user_id`='$user_id' ORDER BY tbl_follows.`id` DESC";
			...
			$sql="SELECT tbl_follows.* FROM tbl_follows, tbl_users 
		      WHERE tbl_follows.`user_id`=tbl_users.`id` AND tbl_follows.`follower_id`='$user_id' ORDER BY tbl_follows.`id` DESC";
	...
	else if($get_method['method_name']=="user_profile_update")	
	{
		...
		{
			$user_edit= "UPDATE tbl_users SET name='".$get_method['name']."',email='".$get_method['email']."',password='".md5(trim($get_method['password']))."',phone='".$get_method['phone']."',user_image='".$user_image."',user_youtube='".$get_method['user_youtube']."',user_instagram='".$get_method['user_instagram']."' WHERE id = '".$get_method['user_id']."'";	 
		}
		else
		{
	...
	else if($get_method['method_name']=="other_user_profile")		
	{
		...
		$qry = "SELECT * FROM tbl_users WHERE `id` = '$other_user_id' AND `status`='1'"; 
		$result = mysqli_query($mysqli,$qry);		
		...
		if($result->num_rows > 0)
		{
			...
			if($user_id!=''){
				$qry1 = "SELECT tbl_follows.* FROM tbl_follows, tbl_users WHERE tbl_follows.`user_id`=tbl_users.`id` AND tbl_follows.`user_id` = '$other_user_id' AND `follower_id`= '$user_id'"; 
			...
			$sql="SELECT tbl_follows.* FROM tbl_follows, tbl_users 
			      WHERE tbl_follows.`follower_id`=tbl_users.`id` AND tbl_follows.`user_id`='$other_user_id' ORDER BY tbl_follows.`id` DESC";
			...
			$sql="SELECT tbl_follows.* FROM tbl_follows, tbl_users 
		      WHERE tbl_follows.`user_id`=tbl_users.`id` AND tbl_follows.`follower_id`='$other_user_id' ORDER BY tbl_follows.`id` DESC";
	...
	else if($get_method['method_name']=="user_rewads_point")		
	{
		...
		while($data = mysqli_fetch_assoc($sql))
		{
			...
			$sql="SELECT * FROM tbl_users_rewards_activity WHERE user_id='$user_id' AND `status`='1' ORDER BY `id` DESC";
	...
	{	
		...
		$sql="SELECT * FROM tbl_users_rewards_activity WHERE user_id='$user_id' AND redeem_id='".$get_method['redeem_id']."' AND `status` = '0' ORDER BY id DESC";
	...
	{	
		...
		$update_points=mysqli_query($mysqli,"UPDATE tbl_users SET total_point='0' WHERE `id` = '$user_id'");

		$updated_activity=mysqli_query($mysqli,"UPDATE tbl_users_rewards_activity SET `redeem_id`='$redeem_id', `status`='0' WHERE `user_id` = '$user_id' AND `status` = '1'");
	...
	{	
	    ...
	    $query="SELECT * FROM tbl_users_redeem WHERE tbl_users_redeem.`user_id`='".$get_method['user_id']."' ORDER BY tbl_users_redeem.`id` DESC";
		...
		if($get_method['filter_value']!="")
 		{
			...
			{
				$query="SELECT tbl_video.*, tbl_category.`cid`, tbl_category.`category_name` FROM tbl_video
				LEFT JOIN tbl_category ON tbl_video.`cat_id`=tbl_category.`cid` 
				WHERE tbl_video.`user_id`='".$user_id."' AND tbl_video.`video_layout`='$filter_value' ORDER BY tbl_video.`id` ".$post_order_by." LIMIT $limit, $page_limit";
			}
			else
			{
				$query="SELECT tbl_video.*, tbl_category.`cid`, tbl_category.`category_name` FROM tbl_video
				LEFT JOIN tbl_category ON tbl_video.`cat_id`=tbl_category.`cid` 
				WHERE tbl_video.`user_id`='".$user_id."' AND tbl_video.`status`='1' AND tbl_video.`video_layout`='$filter_value' ORDER BY tbl_video.`id` ".$post_order_by." LIMIT $limit, $page_limit";
			}
			...
			if($get_method['login_user']=='true')
			{
			    $query="SELECT tbl_img_status.*, tbl_category.`cid`, tbl_category.`category_name` FROM tbl_img_status
				LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
				WHERE tbl_img_status.`user_id`='".$user_id."' AND tbl_img_status.`image_layout`='$filter_value' ORDER BY tbl_img_status.`id` ".$post_order_by." LIMIT $limit, $page_limit";
			}
			else
			{
				$query="SELECT tbl_img_status.*, tbl_category.`cid`, tbl_category.`category_name` FROM tbl_img_status
				LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
				WHERE tbl_img_status.`user_id`='".$user_id."' AND tbl_img_status.`status`='1' AND tbl_img_status.`image_layout`='$filter_value' ORDER BY tbl_img_status.`id` ".$post_order_by." LIMIT $limit, $page_limit";
			}
			...
			if($get_method['login_user']=='true')
			{
			    $query="SELECT tbl_quotes.*, tbl_category.`cid`, tbl_category.`category_name` FROM tbl_quotes
				LEFT JOIN tbl_category ON tbl_quotes.`cat_id`=tbl_category.`cid` 
				WHERE tbl_quotes.`user_id`='".$user_id."' ORDER BY tbl_quotes.`id` ".$post_order_by." LIMIT $limit, $page_limit";
			}
			else
			{
				$query="SELECT tbl_quotes.*, tbl_category.`cid`, tbl_category.`category_name` FROM tbl_quotes
				LEFT JOIN tbl_category ON tbl_quotes.`cat_id`=tbl_category.`cid` 
				WHERE tbl_quotes.`user_id`='".$user_id."' AND tbl_quotes.`status`='1' ORDER BY tbl_quotes.`id` ".$post_order_by." LIMIT $limit, $page_limit";
			}
 		...
 		else
 		{
			...
			if($get_method['login_user']=='true')
			{
			    $query="SELECT tbl_img_status.*, tbl_category.`cid`, tbl_category.`category_name` FROM tbl_img_status
				LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
				WHERE tbl_img_status.`user_id`='".$user_id."' ORDER BY tbl_img_status.`id` ".$post_order_by." LIMIT $limit, $page_limit";
			}
			else
			{
				$query="SELECT tbl_img_status.*, tbl_category.`cid`, tbl_category.`category_name` FROM tbl_img_status
				LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
				WHERE tbl_img_status.`user_id`='".$user_id."' AND tbl_img_status.`status`='1' ORDER BY tbl_img_status.`id` ".$post_order_by." LIMIT $limit, $page_limit";
			}
		...
		while($row_favourite=mysqli_fetch_assoc($res)) {
			...
			switch ($type) {
						...
						if($get_method['filter_value']!="")
 						{
 							$query="SELECT tbl_video.*, tbl_category.`category_name` FROM tbl_video
								LEFT JOIN tbl_category ON tbl_video.`cat_id`=tbl_category.`cid` 
								WHERE tbl_video.`id`='".$post_id."' AND tbl_video.`video_layout`='".$get_method['filter_value']."' ORDER BY tbl_video.`id` ".$post_order_by." LIMIT $limit, $page_limit";
 						}
 						else{
 							$query="SELECT tbl_video.*, tbl_category.`category_name` FROM tbl_video
								LEFT JOIN tbl_category ON tbl_video.`cat_id`=tbl_category.`cid` 
								WHERE tbl_video.`id`='".$post_id."' ORDER BY tbl_video.`id` ".$post_order_by." LIMIT $limit, $page_limit";
						}
						...
						if($get_method['filter_value']!="")
 						{
							...
							$query="SELECT tbl_img_status.*, tbl_category.`category_name` FROM tbl_img_status
								LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
								WHERE tbl_img_status.`id`='".$post_id."' AND  tbl_img_status.`status_type`='".$type."' AND tbl_img_status.`image_layout`='".$get_method['filter_value']."' ORDER BY tbl_img_status.`id` ".$post_order_by." LIMIT $limit, $page_limit";
 						}
 						else{
 							$query="SELECT tbl_img_status.*, tbl_category.`category_name` FROM tbl_img_status
								LEFT JOIN tbl_category ON tbl_img_status.`cat_id`=tbl_category.`cid` 
								WHERE tbl_img_status.`id`='".$post_id."' AND  tbl_img_status.`status_type`='".$type."' ORDER BY tbl_img_status.`id` ".$post_order_by." LIMIT $limit, $page_limit";
						}
				...
				case 'quote':
					{
						// for quotes status
						$query="SELECT tbl_quotes.*, tbl_category.`category_name` FROM tbl_quotes
							LEFT JOIN tbl_category ON tbl_quotes.`cat_id`=tbl_category.`cid` 
							WHERE tbl_quotes.`id`='".$post_id."' AND tbl_category.`status`='1' ORDER BY tbl_quotes.`id` ".$post_order_by." LIMIT $limit, $page_limit";
   	...
   	else if($get_method['method_name']=="user_status_delete")
   	{
		...
		switch ($type) {
			case 'video':
				...
				$sql="SELECT * FROM tbl_video WHERE id IN ($post_id)";
				...
				$deleteSql="DELETE FROM tbl_video WHERE `id` IN ($post_id)";

				mysqli_query($mysqli, $deleteSql);

				$delete_comment="DELETE FROM tbl_comments WHERE `post_id` IN ($post_id) AND `type`='video'";

				mysqli_query($mysqli, $delete_comment);

				$delete_report="DELETE FROM tbl_reports WHERE `post_id` IN ($post_id) AND `report_type`='video'";
			...
			case 'image':
				...
				$sql="SELECT * FROM tbl_img_status WHERE `id` IN ($post_id) AND `status_type`='image'";
				$res=mysqli_query($mysqli, $sql) or die(mysqli_error($mysqli));
				...
				$deleteSql="DELETE FROM tbl_img_status WHERE `id` IN ($post_id) AND `status_type`='image'";

				mysqli_query($mysqli, $deleteSql);

				$delete_comment="DELETE FROM tbl_comments WHERE `post_id` IN ($post_id) AND `type`='image'";

				mysqli_query($mysqli, $delete_comment);

				$delete_report="DELETE FROM tbl_reports WHERE `post_id` IN ($post_id) AND `report_type`='image'";
			...
			case 'gif':
				...
				$sql="SELECT * FROM tbl_img_status WHERE `id` IN ($post_id) AND `status_type`='gif'";
				$res=mysqli_query($mysqli, $sql) or die(mysqli_error($mysqli));
				...
				$deleteSql="DELETE FROM tbl_img_status WHERE `id` IN ($post_id) AND `status_type`='gif'";

				mysqli_query($mysqli, $deleteSql);

				$delete_comment="DELETE FROM tbl_comments WHERE `post_id` IN ($post_id) AND `type`='gif'";

				mysqli_query($mysqli, $delete_comment);

				$delete_report="DELETE FROM tbl_reports WHERE `post_id` IN ($post_id) AND `report_type`='gif'";
			...
			case 'quote':
				...
				$deleteSql="DELETE FROM tbl_quotes WHERE `id` IN ($post_id)";

				mysqli_query($mysqli, $deleteSql);

				$delete_comment="DELETE FROM tbl_comments WHERE `post_id` IN ($post_id) AND `type`='quote'";

				mysqli_query($mysqli, $delete_comment);

				$delete_report="DELETE FROM tbl_reports WHERE `post_id` IN ($post_id) AND `report_type`='quote'";
	...
	else if($get_method['method_name']=="add_status_comment")	
	{
		...
		if($last_id > 0)
		{
			...
			$set['total_comment'] = strval(CountRow("tbl_comments","post_id='".$get_method['post_id']."' AND type='".$get_method['type']."'"));			 
	...
	{	
  	...
  	{		
  		...
  		if($report!=''){
          	...
          	$insert = Insert('tbl_reports',$data);
	...
	else if($get_method['method_name']=="points_details")		
	{
	    ...
	    $query="SELECT * FROM tbl_users_redeem WHERE tbl_users_redeem.`id`='".$get_method['redeem_id']."' ORDER BY tbl_users_redeem.`id` DESC";
	...
	else if($get_method['method_name']=="get_spinner")
	{
		...
		if($user_id!='' || isset($user_id)){
			$query="SELECT count(*) AS total_cnt FROM  tbl_users_rewards_activity activity WHERE activity.`user_id`='$user_id' AND activity.`activity_type`='".$app_lang['lucky_spin_lbl']."' AND DATE_FORMAT(activity.`date`, '%Y-%m-%d') = CURDATE()";
	...
	else if($get_method['method_name']=="delete_comment")
	{
		...
		$sql="SELECT * FROM tbl_comments WHERE tbl_comments.`post_id`='$post_id' AND `type`='$type' ORDER BY tbl_comments.`id` DESC LIMIT 1 OFFSET 2";
		...
		if(mysqli_num_rows($res) > 0){
			...
			$set['total_comment'] = CountRow('tbl_comments',"post_id='$post_id' AND type='$type'");
	...
	else if($get_method['method_name']=="get_all_comments")
	{
		...
		$sql="SELECT * FROM tbl_comments WHERE tbl_comments.`post_id`='$post_id' AND tbl_comments.`user_id`='$user_id' AND tbl_comments.`type`='$type' AND tbl_comments.`status`='1' ORDER BY tbl_comments.`id` DESC LIMIT $limit, $page_limit";
		...
		if(mysqli_num_rows($res) > 0){
			while ($row=mysqli_fetch_assoc($res)) {
				...
				$info['total_comment'] = CountRow('tbl_comments',"post_id='$post_id' AND type='$type'");;			 
	...
	else if($get_method['method_name']=="get_payment_mode")	
	{
		...
		$query="SELECT * FROM tbl_payment_mode WHERE status='1' ORDER BY `id` ASC";
		$sql = mysqli_query($mysqli,$query);
	...
	else if($get_method['method_name']=="apply_user_refrence_code")		
	{
		...
		$user_qry="SELECT * FROM tbl_users WHERE `user_code`='$user_refrence_code' AND `id` <> '$user_id'";
		$user_result=mysqli_query($mysqli,$user_qry);
		$user_row=mysqli_fetch_assoc($user_result);
